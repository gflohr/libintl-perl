...
# NOTE this test may fail with gettext_xs and GNU gettext, as seen here:
# https://lists.gnu.org/archive/html/bug-gettext/2026-04/msg00007.html
...
# with only fr_FR in catalogs, test if fr is nevertheless found in fr_FR
# after loading fr_FR previously
nl_putenv "LANGUAGE=fr";
ok gettext "January", "January";
