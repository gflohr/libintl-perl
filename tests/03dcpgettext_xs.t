...
ok 'Anzeigen' eq dcgettext (existing => 'View', LC_MESSAGES);
ok 'Ansicht' eq dcpgettext (existing => 'Which folder would you like to view?','View', LC_MESSAGES);
ok 'Not translated' eq dcpgettext (existing => 'none', 'Not translated', LC_MESSAGES);

skip $missing_locale, 'Ein weiterer Blick' eq dcpgettext (additional => 'Context', 'Another View', LC_MESSAGES);
ok 'Not translated' eq dcpgettext (additional => 'none', 'Not translated', LC_MESSAGES);
skip $missing_locale, 'Ein weiterer Blick' eq dcpgettext (additional => 'Context', 'Another View', LC_MESSAGES);
