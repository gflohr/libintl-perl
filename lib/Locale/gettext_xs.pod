...
# vim: tabstop=4
# $Id: gettext_xs.pod,v 1.1 2003/09/15 08:21:46 guido Exp $
...
The interface of B<Locale::gettext_xs> is identical to the pure Perl
version as described in Locale::gettext_pp(3), see there for details.
