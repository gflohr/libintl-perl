...
my $cd_int = Locale::Iconv->new (from => 'ASMO_449',
			     		  		 to => 'INTERNAL');
ok !$cd_int->getError;

my $cd_utf8 = Locale::Iconv->new (from => 'ASMO_449',
								  to => 'UTF-8');
ok !$cd_utf8->getError;
...
# Check handling of unknown characters.  Our usual string does not
# work here!
my $test_string = [ unpack 'c*', ' 0123456789 ' ];
$test_string->[0] = 0xad0be;
$test_string->[-1] = 0xbeefbabe;
$cd_utf8 = Locale::Iconv->new (from => 'INTERNAL',
							   to => 'ASMO_449',
							   unknown => ord '*',
							  );
$result_utf8 = $cd_utf8->recode ($test_string);
ok '*0123456789*' eq $test_string;
