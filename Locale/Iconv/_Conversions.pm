#! /bin/false
# -*- perl -*-
# $Id: _Conversions.pm,v 1.1.1.1 2002/07/08 19:19:59 guido Exp $
...
Locale::Iconv::_Conversions

=head1 SYNOPSIS

use Locale::Iconv::_Conversions
...
The constant B<Locale::Iconv::_Conversions::CONVERSIONS> contains a hash 
...
to a particular module name under the module hierarchy  'Locale::IconvData::'.
